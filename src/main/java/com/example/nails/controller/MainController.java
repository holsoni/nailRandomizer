...
public class MainController {
    ...
    public String getByDesign(@PathVariable(value = "design") String design, Model model){
        this.service.getByDesign(neededManicure.getForm(), neededManicure.getColor(),design);
        neededManicure.setDesign(design);
        List<Manicure> manicuresWithDesign = service.getByDesign(neededManicure.getForm(), neededManicure.getColor(),design);
    ...
    public String showResult( Model model){
        List<Manicure> result = service.getByDesign(neededManicure.getForm(), neededManicure.getColor(), neededManicure.getDesign());
